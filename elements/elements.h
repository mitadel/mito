...
template<DIM D>
void computeSimplicesVolume(const std::vector<mito::vector<D> > & vertices, 
...
template<DIM D>
void computeSegmentsLength(const std::vector<mito::vector<D> > & vertices, 
...
void computeElementsVolume(const std::vector<mito::vector<D> > & vertices, 
    std::vector<real> & volumes);

template<>
void computeElementsVolume<4, DIM3>(const std::vector<mito::vector<DIM3> > & vertices, 
    std::vector<real> & volumes)
{
...
template<>
void computeElementsVolume<3, DIM2>(const std::vector<mito::vector<DIM2> > & vertices, 
    std::vector<real> & volumes)
{
...
template<>
void computeElementsVolume<2, DIM2>(const std::vector<mito::vector<DIM2> > & vertices, 
    std::vector<real> & volumes)
{
...
template<>
void computeElementsVolume<2, DIM3>(const std::vector<mito::vector<DIM3> > & vertices, 
    std::vector<real> & volumes)
{
...
template<>
void computeElementsVolume<2, DIM1>(const std::vector<mito::vector<DIM1> > & vertices, 
    std::vector<real> & volumes) 
{
