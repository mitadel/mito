...
mito::vector<2>
myFunctionC(const mito::vector<3> & x, mito::real t)
{
    return { (x[0] - 1) * (x[1] - 1), 0.0 };
}

mito::real
myFunctionVector2DtoReal(const mito::vector<2> & x, mito::real t)
{
    return (x[0] - 1) * (x[1] - 1);
}

mito::real
myFunctionTensor3DtoReal(const mito::tensor<3> & x, mito::real t)
{
    return x[0] + x[4] + x[8];
}
...
main()
{
    ...
    mito::field<mito::vector<3>, mito::vector<3>> myFunctionB { [](const mito::vector<3> & x,
                                                                   mito::real t) {
    ...
    mito::field<mito::vector<3>, mito::vector<2>> myFunction3DtoReal { [](const mito::vector<3> & x,
                                                                          mito::real t) {
