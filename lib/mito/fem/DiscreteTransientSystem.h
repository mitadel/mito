...
namespace mito::fem {
    ...
    class DiscreteTransientSystem {
      ...
      public:
        // constructor
        constexpr DiscreteTransientSystem(
        ...
        // destructor
        constexpr ~DiscreteTransientSystem() = default;

        // delete move constructor
        constexpr DiscreteTransientSystem(DiscreteTransientSystem &&) noexcept = delete;

        // delete copy constructor
        constexpr DiscreteTransientSystem(const DiscreteTransientSystem &) = delete;

        // delete assignment operator
        constexpr DiscreteTransientSystem & operator=(const DiscreteTransientSystem &) = delete;

        // delete move assignment operator
        constexpr DiscreteTransientSystem & operator=(DiscreteTransientSystem &&) noexcept = delete;
