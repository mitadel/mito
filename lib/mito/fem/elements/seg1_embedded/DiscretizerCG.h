...
namespace mito::fem {
    ...
    // discretizer specialization for {IsoparametricEmbeddedSegmentP1} with continuous Galerkin
    template <>
    struct Discretizer<IsoparametricEmbeddedSegmentP1, discretization_t::CG> {
        template <
            ...
            map_type & node_map, constrained_nodes_type & constrained_nodes)
        {
            ...
            using discretization_node_type =
                typename IsoparametricEmbeddedSegmentP1::discretization_node_type;

            // the connectivity type
            using connectivity_type = typename IsoparametricEmbeddedSegmentP1::connectivity_type;
