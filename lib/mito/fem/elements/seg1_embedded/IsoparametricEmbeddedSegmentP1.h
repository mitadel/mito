...
namespace mito::fem {
    ...
    class IsoparametricEmbeddedSegmentP1 : public IsoparametricEmbeddedSegment {
      ...
      public:
        ...
        // the type of shape functions (reuse from seg1, same 1D parametric shape functions)
      ...
      public:
        ...
        constexpr auto jacobian() const
        {
            ...
            auto jacobian_function = functions::function(
                [&](const parametric_coordinates_type & xi) -> tensor::matrix_t<2, 1> {
                    ...
                    // wrap the result in a 2x1 matrix
