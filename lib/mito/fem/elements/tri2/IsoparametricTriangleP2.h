...
// DESIGN NOTES
// Class {IsoparametricTriangleP2} represents a second order simplex (triangle) living in 2D
// cartesian space, equipped with quadratic shape functions defined in the parametric space.
