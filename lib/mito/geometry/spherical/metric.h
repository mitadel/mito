...
namespace mito::geometry {
    ...
    struct metric<spherical_coordinates_t> {
        static constexpr auto field()
        {
            ...
            constexpr auto e_rr = fields::uniform_field<spherical_coordinates_t>(e_00<3>);
            // the function returning the constant e_11 tensor in 3D
            constexpr auto e_tt = fields::uniform_field<spherical_coordinates_t>(e_11<3>);
            // the function returning the constant e_11 tensor in 3D
            constexpr auto e_pp = fields::uniform_field<spherical_coordinates_t>(e_22<3>);
