...
namespace mito::io::summit {
        ...
        std::string elementType) -> void
    {
        ...
        // populate the file heading
        // TOFIX: number of materials is always 1 for now
        // TOFIX: number of element types and formulations is always 1 for now
        outfile << D << std::endl;
        outfile << std::size(points) << " " << mesh.nCells() << " " << 1 << " " << 1 << std::endl;
        ...
        for (const auto & cell : mesh.cells()) {
            ...
            // TOFIX: material label is always 1 for now
            outfile << 1 << " " << elementType << std::endl;
        }
