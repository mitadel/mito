...
namespace mito::materials {
    ...
    constexpr auto Gent::stress(const deformation_gradient_type & F) const -> stress_type
    {
        // precompute useful quantities
    ...
    constexpr auto Gent::tangents(const deformation_gradient_type & F) const -> tangents_type
    {
        // precompute useful quantities
        // inverse of deformation gradient
        auto invF = inverse(F);
