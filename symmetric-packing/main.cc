...
constexpr int offsetN(index_t<N> index)
{
    // sort the index
...
int main() {
    ...
    static_assert(offsetN<2 /* N */, 2 /* D */>(
        index_t<2 /* N */>{1 /*D - 1*/, 1 /*D - 1*/}) 
        == entries<2 /* N */>(2 /* D */) - 1);
    static_assert(offsetN<3 /* N */, 2 /* D */>(
        index_t<3 /* N */>{1 /*D - 1*/, 1 /*D - 1*/, 1 /*D - 1*/})
        == entries<3 /* N */>(2 /* D */) - 1);
    static_assert(offsetN<2 /* N */, 3 /* D */>(
        index_t<2 /* N */>{2 /*D - 1*/, 2 /*D - 1*/}) 
        == entries<2 /* N */>(3 /* D */) - 1);
    static_assert(offsetN<3 /* N */, 3 /* D */>(
        index_t<3 /* N */>{2 /*D - 1*/, 2 /*D - 1*/, 2 /*D - 1*/}) 
        == entries<3 /* N */>(3 /* D */) - 1);
    static_assert(offsetN<4 /* N */, 3 /* D */>(
