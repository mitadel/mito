...
TEST(Fem, ShapeTriangleP2)
{
    ...
    constexpr auto n0 = parametric_coordinates_t{ 0.0, 0.0 };
    // node 1 in parametric coordinates
    constexpr auto n1 = parametric_coordinates_t{ 1.0, 0.0 };
    // node 2 in parametric coordinates
    constexpr auto n2 = parametric_coordinates_t{ 0.0, 1.0 };
    // node 3 in parametric coordinates
    constexpr auto n3 = parametric_coordinates_t{ 0.5, 0.0 };
    // node 4 in parametric coordinates
    constexpr auto n4 = parametric_coordinates_t{ 0.5, 0.5 };
    // node 5 in parametric coordinates
    constexpr auto n5 = parametric_coordinates_t{ 0.0, 0.5 };
