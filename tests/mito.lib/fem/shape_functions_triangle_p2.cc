...
TEST(Fem, ShapeTriangleP2)
{
    ...
    constexpr auto n0 = barycentric_coordinates_t{ 0.0, 0.0 };
    // node 1 in barycentric coordinates
    constexpr auto n1 = barycentric_coordinates_t{ 1.0, 0.0 };
    // node 2 in barycentric coordinates
    constexpr auto n2 = barycentric_coordinates_t{ 0.0, 1.0 };
    // node 3 in barycentric coordinates
    constexpr auto n3 = barycentric_coordinates_t{ 0.5, 0.0 };
    // node 4 in barycentric coordinates
    constexpr auto n4 = barycentric_coordinates_t{ 0.5, 0.5 };
    // node 5 in barycentric coordinates
    constexpr auto n5 = barycentric_coordinates_t{ 0.0, 0.5 };
    ...
    // check that the shape function at node 3 is 0.0
    static_assert(0.0 == phi_1(n3));
    // check that the shape function at node 4 is 0.0
    static_assert(0.0 == phi_1(n4));
    // check that the shape function at node 5 is 0.0
    static_assert(0.0 == phi_1(n5));
    ...
    // check that the shape function at node 3 is 0.0
    static_assert(0.0 == phi_2(n3));
    // check that the shape function at node 4 is 0.0
    static_assert(0.0 == phi_2(n4));
    // check that the shape function at node 5 is 0.0
    static_assert(0.0 == phi_2(n5));

    // the shape functions at node 3
    constexpr auto phi_3 = element.shape<3>();
    // check that the shape function at node 0 is 0.0
    static_assert(0.0 == phi_3(n0));
    // check that the shape function at node 1 is 0.0
    static_assert(0.0 == phi_3(n1));
    // check that the shape function at node 2 is 0.0
    static_assert(0.0 == phi_3(n2));
    // check that the shape function at node 3 is 1.0
    static_assert(1.0 == phi_3(n3));
    // check that the shape function at node 4 is 0.0
    static_assert(0.0 == phi_3(n4));
    // check that the shape function at node 5 is 0.0
    static_assert(0.0 == phi_3(n5));

    // the shape functions at node 4
    constexpr auto phi_4 = element.shape<4>();
    // check that the shape function at node 0 is 0.0
    static_assert(0.0 == phi_4(n0));
    // check that the shape function at node 1 is 0.0
    static_assert(0.0 == phi_4(n1));
    // check that the shape function at node 2 is 0.0
    static_assert(0.0 == phi_4(n2));
    // check that the shape function at node 3 is 0.0
    static_assert(0.0 == phi_4(n3));
    // check that the shape function at node 4 is 1.0
    static_assert(1.0 == phi_4(n4));
    // check that the shape function at node 5 is 0.0
    static_assert(0.0 == phi_4(n5));

    // the shape functions at node 5
    constexpr auto phi_5 = element.shape<5>();
    // check that the shape function at node 0 is 0.0
    static_assert(0.0 == phi_5(n0));
    // check that the shape function at node 1 is 0.0
    static_assert(0.0 == phi_5(n1));
    // check that the shape function at node 2 is 0.0
    static_assert(0.0 == phi_5(n2));
    // check that the shape function at node 3 is 0.0
    static_assert(0.0 == phi_5(n3));
    // check that the shape function at node 4 is 0.0
    static_assert(0.0 == phi_5(n4));
    // check that the shape function at node 5 is 1.0
    static_assert(1.0 == phi_5(n5));
