...
TEST(Manifolds, Metric)
{
    ...
    constexpr auto euclidean_metric = mito::geometry::metric<cartesian_coordinates_t>::field();
    ...
    // the polar metric
    constexpr auto polar_metric = mito::geometry::metric<polar_coordinates_t>::field();
