...
test()
{
...

    {
        ...
        original_mesh_nodes = mito::fem::nodal_field<mito::tensor::scalar_t>(mesh, "field").size();
    ...
    }
    {
        ...
        reread_mesh_nodes = mito::fem::nodal_field<mito::tensor::scalar_t>(mesh, "field").size();
