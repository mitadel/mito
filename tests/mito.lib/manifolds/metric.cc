...
TEST(Manifolds, Metric)
{
    ...
    constexpr auto euclidean_metric = mito::manifolds::metric<cartesian_coordinates_t>::field();
    ...
    // the polar metric
    constexpr auto polar_metric = mito::manifolds::metric<polar_coordinates_t>::field();
