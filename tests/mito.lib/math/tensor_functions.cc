...
TEST(Math, TensorFunctions)
{
    ...
    // a point in space
    constexpr auto x = 2.0 * mito::math::e_1<3> + mito::math::e_2<3>;
    ...
    constexpr auto B1 = f * mito::math::e_12<3> + g * mito::math::e_22<3>;
    ...
    constexpr auto A = 3.0 * mito::math::e_12<3> + 4.0 * mito::math::e_22<3>;
