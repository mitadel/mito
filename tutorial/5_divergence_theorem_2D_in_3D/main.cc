...
main()
{
    ...
    auto mesh = mesh::mesh<geometry::triangle_t<3>>();
    ...
    */
    ...
    // build nodes
    auto node_0 = geometry::node(coord_system, { 0.0, 0.0, 0.0 });
    auto node_1 = geometry::node(coord_system, { 1.0, 0.0, 0.0 });
    auto node_2 = geometry::node(coord_system, { 1.0, 1.0, 0.0 });
    auto node_3 = geometry::node(coord_system, { 0.5, 0.5, 0.0 });
    auto node_4 = geometry::node(coord_system, { 0.0, 1.0, 0.0 });
    ...
    auto bodyManifold = manifolds::submanifold(mesh, coord_system, e_2);
    ...
    auto boundary_manifold = manifolds::submanifold(boundary_mesh, coord_system, e_2, n);
